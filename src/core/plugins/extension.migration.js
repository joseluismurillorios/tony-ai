...
export default ($) => {
  ...
  const prepOptions = function prepOptions(o) {
    // PARALLAX FALLBACKS
    ...
    if (o.navigation === undefined) {
      ...
      if (o.navigationArrows === 'solo' || o.navigationArrows === 'nextto') {
        ...
        a.hide_onmobile = o.hideArrowsOnMobile === 'on';
        a.hide_onleave = o.hideThumbs > 0;
      ...
      if (o.navigationType === 'bullet') {
        ...
        b.enable = true;
        b.hide_onmobile = o.hideArrowsOnMobile === 'on';
        b.hide_onleave = o.hideThumbs > 0;
      ...
      if (o.navigationType === 'thumb') {
        ...
        t.hide_onmobile = o.hideArrowsOnMobile === 'on';
        t.hide_onleave = o.hideThumbs > 0;
  ...
  const prepLayerAnimations = function prepLayerAnimations(container) {
    const c = {};
