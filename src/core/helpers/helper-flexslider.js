...
export default (jQuery) => {
  ...
  jQuery.flexslider = function(el, options) {
    ...
    methods = {
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = jQuery('<ul class="' + namespace + 'direction-nav"><li class="' + namespace + 'nav-prev"><a class="' + namespace + 'prev" href="#">' + slider.vars.prevText + '</a></li><li class="' + namespace + 'nav-next"><a class="' + namespace + 'next" href="#">' + slider.vars.nextText + '</a></li></ul>');
      ...
      uniqueID: function(jQueryclone) {
        ...
        jQueryclone.filter( '[id]' ).add(jQueryclone.find( '[id]' )).each(function() {
          var jQuerythis = jQuery(this);
